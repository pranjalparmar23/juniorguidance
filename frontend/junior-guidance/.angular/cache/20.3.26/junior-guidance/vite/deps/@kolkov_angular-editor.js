...
// node_modules/@kolkov/angular-editor/fesm2022/kolkov-angular-editor.mjs
var _c0 = ["labelButton"];
var _c1 = (a0) => ({
  "ae-expanded": a0
});
...
function AeSelectComponent_span_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = ɵɵgetCurrentView();
    ɵɵelementStart(0, "span", 6);
    ɵɵlistener("mousedown", function AeSelectComponent_span_7_Template_span_mousedown_0_listener($event) {
...
var AngularEditorService = class _AngularEditorService {
  ...
  getBlockElementsInRange(range) {
    const blockTags = ["P", "DIV", "H1", "H2", "H3", "H4", "H5", "H6", "LI", "BLOCKQUOTE", "PRE", "ADDRESS", "ARTICLE", "ASIDE", "FIGCAPTION", "FIGURE", "FOOTER", "HEADER", "MAIN", "NAV", "SECTION"];
    const blocks = [];
...
var AeSelectComponent = class _AeSelectComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    decls: 9,
    vars: 9,
    consts: [["labelButton", ""], [1, "ae-picker", 3, "ngClass"], ["tabindex", "-1", "type", "button", "role", "button", 1, "ae-picker-label", 3, "click", "tabIndex"], [1, "ae-picker-options"], ["tabindex", "-1", "type", "button", "role", "button", "class", "ae-picker-item", 3, "ngClass", "mousedown", 4, "ngFor", "ngForOf"], ["class", "dropdown-item", 4, "ngIf"], ["tabindex", "-1", "type", "button", "role", "button", 1, "ae-picker-item", 3, "mousedown", "ngClass"], [1, "dropdown-item"]],
    template: function AeSelectComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        ɵɵtemplate(7, AeSelectComponent_span_7_Template, 2, 5, "span", 4)(8, AeSelectComponent_span_8_Template, 2, 0, "span", 5);
        ɵɵelementEnd()();
      }
      if (rf & 2) {
        ɵɵproperty("ngClass", ɵɵpureFunction1(7, _c1, ctx.isOpen));
        ɵɵadvance();
...
var AeToolbarComponent = class _AeToolbarComponent {
  r;
  editorService;
  er;
  doc;
  ...
  static ɵfac = function AeToolbarComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _AeToolbarComponent)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(AngularEditorService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _AeToolbarComponent,
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function AngularEditorComponent_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        ɵɵproperty("ngClass", ɵɵpureFunction1(30, _c9, ctx.config.toolbarPosition === "bottom"));
        ɵɵadvance(2);
        ...
        ɵɵadvance(2);
        ɵɵproperty("ngTemplateOutlet", ctx.customButtonsTemplateRef)("ngTemplateOutletContext", ɵɵpureFunction1(32, _c10, ctx.executeCommandFn));
        ɵɵadvance(3);
        ...
        ɵɵattribute("contenteditable", ctx.config.editable)("tabindex", ctx.disabled ? -1 : ctx.tabIndex)("translate", ctx.config.translate)("spellcheck", ctx.config.spellcheck)("dir", ctx.config.textDirection);
        ɵɵadvance(3);
        ɵɵtextInterpolate(ctx.placeholder || ctx.config["placeholder"]);
      }
    },
    dependencies: [NgClass, NgTemplateOutlet, AeToolbarComponent],
