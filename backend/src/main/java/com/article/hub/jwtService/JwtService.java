...
public class JwtService {
    ...
    public static final String SECRET = "asdfghjkl927rtyuioq23wertyui456okjhgfdwrh4j8038ndbocpkk21920wsckoksdwhde773023hdpwuu";
    ...
    private String createToken(Map<String, Object> claims, String userName){
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + 1000 * 60 * 120)) //token expiration time for 2 hours
